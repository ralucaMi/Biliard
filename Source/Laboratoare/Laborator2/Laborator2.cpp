...
void Laborator2::Init()
{
	...
	// Create a mesh box using custom data
	{
		vector<VertexFormat> vertices
		{
			...
			VertexFormat(glm::vec3(1, 0, 1), glm::vec3(1, 1, 0)),
		...
		vector<VertexFormat> vertices2
		{
			...
			VertexFormat(glm::vec3(2, 0, 2), glm::vec3(1, 1, 1)),
			VertexFormat(glm::vec3(0, 0, 2), glm::vec3(0, 1, 0)),
			VertexFormat(glm::vec3(1, 3, 1), glm::vec3(0, 1, 0)),
		...
		vector<unsigned short> indices3 =
		{
			//2, 1, 0,
			//2, 3, 0
			//ordinea in care punctele sunt legate: 0 cu 3, apoi cu 2
			0, 3, 2,
			0, 1, 2
		...
		Mesh *square = CreateMesh("square", vertices3, indices3);
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(0.5f, 0.3f, 0.7), glm::vec3(0.35f));

	RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(1.2f, 0.8f, 0.7), glm::vec3(0.7f));
